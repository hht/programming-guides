...
| 学习参考（非默认） | [pmndrs/react-spring](https://github.com/pmndrs/react-spring)、[motiondivision/motion](https://github.com/motiondivision/motion) | 学边界与声明式 API；**不**约定依赖 |
...
锁版本：应用仓 lockfile；本指南不指定具体 semver，约定**能力边界**（白名单 + 预算 + 测量）。
