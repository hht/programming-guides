...
design/
  ...
  figma-notes.md            # file URL、Frame 列表、a11y: PASS（路径钉死本文件）
```
...
1. 设计仓建 `UBIQUITOUS_LANGUAGE.md`（仓根默认；或 `design/UBIQUITOUS_LANGUAGE.md`，二选一写进 INPUTS §11 备注）。表头钉死：`Term | 含义 | 代码/设计符号 | 禁同义词`。  
