...
2. 在目标仓库初始化默认栈（[01](./01-stack-and-react19.md)）；目录按 [02](./02-directory-and-naming.md)  
...
6. [commands.md](./commands.md) 门禁绿 + [10](./10-checklist.md) + [11](./11-world-class-acceptance.md) 全勾  
