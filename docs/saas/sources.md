...
| B | [makeplane/plane](https://github.com/makeplane/plane) | P1 | Workspace 隔离、成员角色、项目作用域 | 绑死其前端目录 | 多租户项目管理：工作区与成员 |
...
| 支付商百科 / Stripe 唯一默认 | — | — | — | **禁止**钉死；INPUTS 条件；细节 → [payments](../payments/README.md) |
...
| Stripe 在 cal.com 很重 | **不**钉唯一支付商；本册只钉计费状态机与席位门闸 |
